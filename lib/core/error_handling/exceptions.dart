...
class UnhandledException extends AppException {
  const UnhandledException([String? message, String? from])
...
class DataNotFoundException extends AppException {
  const DataNotFoundException(String message, [String? from])
      : super(message, from);
...
class InternalServerErrorException extends AppException {
  const InternalServerErrorException([String? message, String? from])
      : super(message, from);
...
class NoConnectionException extends AppException {
  const NoConnectionException([String? message, String? from])
      : super(message, from);
...
class PoorConnectionException extends AppException {
  const PoorConnectionException([String? message, String? from])
      : super(message, from);
...
class ServerConnectionFailureException extends AppException {
  const ServerConnectionFailureException([String? message, String? from])
      : super(message, from);
...
class DataParsingException extends AppException {
  const DataParsingException(String message, [String? from])
      : super(message, from);
...
class DataMappingException extends AppException {
  const DataMappingException(String message, [String? from])
      : super(message, from);
